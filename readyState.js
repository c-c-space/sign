...
document.addEventListener('readystatechange', event => {
  if (event.target.readyState === 'loading') {
    ...
    if(!localStorage.getItem('sign')) {
      ...
      yourAll.innerHTML += `<li><p><i>Sign | creative-community.space</i><b id="ip" style="color:#fff;">Colors and Symbols that Suits on You</b><small>Posted by ${log.os}</small></li>`
